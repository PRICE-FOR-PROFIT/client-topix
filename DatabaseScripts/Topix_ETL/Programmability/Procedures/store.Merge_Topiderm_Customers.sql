...
GO
CREATE PROC [store].[Merge_Topiderm_Customers]

AS

TRUNCATE TABLE store.Topiderm_Customers

INSERT INTO store.Topiderm_Customers (
 [CustomerID]				
,[cus_no]					
,[cus_name]				
,[addr_1]					
...
SELECT [CustomerID]						= 'Topiderm_' + CAST(NULLIF(TRIM([cus_no]),'NULL')	AS VARCHAR(100))
