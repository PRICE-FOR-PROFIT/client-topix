...
GO
CREATE PROC [store].[Merge_Topix_Items]

AS

TRUNCATE TABLE store.Topix_Items

INSERT INTO store.Topix_Items (
 [ItemID]				
,[item_no]			
,[item_desc_1]	
,[item_desc_2]		
...
SELECT [ItemID]							= 'Topix_' + CAST(NULLIF([item_no],'NULL')	AS VARCHAR(255))
