...
GO
CREATE PROC [store].[Merge_ClarityRX_Items]

AS

TRUNCATE TABLE store.ClarityRx_Items

INSERT INTO store.ClarityRx_Items (
 [ItemID]				
,[item_no]			
,[item_desc_1]	
,[item_desc_2]		
...
SELECT [ItemID]							= 'ClarityRx_' + CAST(NULLIF([item_no],'NULL')	AS VARCHAR(255))
