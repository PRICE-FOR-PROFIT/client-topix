...
GO
CREATE PROC [store].[Merge_DermaE_Items]

AS

TRUNCATE TABLE store.DermaE_Items

INSERT INTO store.DermaE_Items (
 [ItemID]				
,[item_no]			
,[item_desc_1]	
,[item_desc_2]		
...
SELECT [ItemID]							= 'DermaE_' + CAST(NULLIF([item_no],'NULL')	AS VARCHAR(255))
