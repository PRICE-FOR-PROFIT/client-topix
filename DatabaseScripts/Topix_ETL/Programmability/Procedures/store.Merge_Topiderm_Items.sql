...
GO
CREATE PROC [store].[Merge_Topiderm_Items]

AS

TRUNCATE TABLE store.Topiderm_Items

INSERT INTO store.Topiderm_Items (
 [ItemID]				
,[item_no]			
,[item_desc_1]	
,[item_desc_2]		
...
SELECT [ItemID]							= 'Topiderm_' + CAST(NULLIF([item_no],'NULL')	AS VARCHAR(255))
