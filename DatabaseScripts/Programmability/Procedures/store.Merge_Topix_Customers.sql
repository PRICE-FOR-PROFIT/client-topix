...
GO
CREATE PROC [store].[Merge_Topix_Customers]

AS

TRUNCATE TABLE store.Topix_Customers

INSERT INTO store.Topix_Customers (
 [CustomerID]				
,[cus_no]					
,[cus_name]				
,[addr_1]					
...
SELECT [CustomerID]						= 'Topix_' + CAST(NULLIF(TRIM([cus_no]),'NULL')			AS VARCHAR(100))
